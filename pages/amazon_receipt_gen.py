...
# PAGE CONTENT GOES HERE #################################################################
        ...
        # Order number ##########
                    ...
                    col_order_number, col_button = st.columns([2, 2])
                    ...
                    with col_button:
                        ...
                        if st.button("Generate order number", use_container_width=True):
        ...
        # Sold by ##########
                    # by_amazon = st.checkbox("Sold by Amazon")
        ...
        # Item quantity ##########       
                    ...
                    try:
                        item_quantity_value = float(item_quantity)
                        item_quantity = float(f"{item_quantity_value:.2f}")
                    except ValueError:
        ...
        # Auto tax ##########           
                    ...
                    if not auto_tax:
                        ...
                        tax = st.text_input("Tax %", value=st.session_state.item_cost, placeholder="7.25")
                        try:
                            tax_value = float(tax)
        ...
        # Customer address ##########          
                    ...
                    last_digits = st.text_input("Payment method last 4 digits", placeholder="4278")
                    ...
                    if st.button("Generate receipt", use_container_width=True):
                        ...
                        with col2:
                            ...
                            with seccontainer:
                                ...
                                st.download_button("Download .html file", rendered_html, mime="text/html")  
                                st.markdown("""
                                    <style>
                                    .custom-underline {
